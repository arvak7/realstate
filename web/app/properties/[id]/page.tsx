        ...
        return (
            <div className="min-h-screen bg-white">
                ...
                <div className="max-w-4xl mx-auto px-6 lg:px-8 py-20 text-center">
                    <h1 className="text-4xl text-kindred-dark mb-4">Immoble no trobat</h1>
                    <p className="text-kindred-gray mb-8">
                        L'immoble que busques no existeix o ha estat eliminat.
                    </p>
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8 py-10">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        <div>
                            ...
                            <div className="flex flex-wrap items-center gap-6 pb-8 border-b border-gray-100">
                                ...
                                <div className="flex gap-4 text-kindred-gray">
                                    <span>{property.basic_info.rooms} habitacions</span>
                        ...
                        {/* Description */}
                        <div>
                            <h2 className="text-xl font-semibold text-kindred-dark mb-4">Descripció</h2>
                            ...
                            <div className="pt-8 border-t border-gray-100">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                                    ...
                                    {property.characteristics.has_elevator !== undefined && (
                                        <div>
                                            <p className="text-kindred-gray text-sm mb-1">Ascensor</p>
                                            <p className="font-semibold text-kindred-dark">{property.characteristics.has_elevator ? "Sí" : "No"}</p>
                                        </div>
                                    )}
                                    {property.characteristics.is_furnished !== undefined && (
                                        <div>
                                            <p className="text-kindred-gray text-sm mb-1">Amoblat</p>
                                            <p className="font-semibold text-kindred-dark">{property.characteristics.is_furnished ? "Sí" : "No"}</p>
                                        </div>
                                    )}
                                </div>
                            </div>
                        ...
                        {property.tags && property.tags.length > 0 && (
                            <div className="pt-8 border-t border-gray-100">
                                <h2 className="text-xl font-semibold text-kindred-dark mb-4">Etiquetes</h2>
                    ...
                    <div className="lg:col-span-1">
                        <div className="bg-neutral-warm/50 rounded-2xl p-6 sticky top-6">
                            <h2 className="text-lg font-semibold text-kindred-dark mb-6">Contacta</h2>

                            {session ? (
                                <>
                                    <div className="mb-6">
                                        <p className="text-kindred-gray text-sm mb-2">Propietari</p>
                                ...
                                <div className="mt-8 pt-6 border-t border-gray-200">
                                    ...
                                    {property.energy.energy_label && (
                                        <div className="flex items-center gap-2 mb-2">
                                            <span className="text-kindred-gray text-sm">Etiqueta:</span>
